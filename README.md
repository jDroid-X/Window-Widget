...
- **🌈 Vibrant Radium & Spectral Themes:**
  ...
  - Plus Dark, Light, Cyberpunk, Emerald, Sapphire, Sunset, and High Contrast themes.
- **🖥️ Smart Screen Docking:**
  ...
  - Responsive font scaling (`Small`, `Medium`, `Large`, `Extra Large`) with proportional layout resizing.
...
3. Install required Python packages (`PyQt5`, `psutil`, `pywin32`, `winshell`).
4. Create the Desktop shortcut (**`OmniBar Hardware Widget`**) and register Windows auto-start.
